...
{
	public partial interface ISchoolOfficeRepository
	{
		...
		Task<IEnumerable<SchoolOffice>> Search(int pageIndex, int pageSize,string sortBy, string orderBy,string searchstring);
		...
		Task<IEnumerable<SchoolOffice>> Search(int pageIndex, int pageSize,string sortBy, string orderBy,string searchstring,int DrivingSchoolAPI);
