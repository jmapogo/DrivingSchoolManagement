...
{
	public partial interface IClientPaymentRepository
	{
		...
		Task<IEnumerable<ClientPayment>> Search(int pageIndex, int pageSize,string sortBy, string orderBy,string searchstring);
		...
		Task<IEnumerable<ClientPayment>> Search(int pageIndex, int pageSize,string sortBy, string orderBy,string searchstring,int DrivingSchoolAPI);
