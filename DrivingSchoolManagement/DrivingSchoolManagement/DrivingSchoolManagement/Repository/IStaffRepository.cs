...
namespace MapogoSoft.DrivingSchoolAPI.Data.Repository
{
	public partial interface IStaffRepository
	{
		...
		Task<IEnumerable<Staff>> Search(int pageIndex, int pageSize,string sortBy, string orderBy,string searchstring);
		...
		Task<IEnumerable<Staff>> Search(int pageIndex, int pageSize,string sortBy, string orderBy,string searchstring,int DrivingSchoolAPI);
